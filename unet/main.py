...
def main():
    ...
    if MODE == "train":
        ...
        plt.title('Baseline Training Progress (Standard UNet)')
    ...
    if MODE in ["train", "test"]:
        print("\n" + "=" * 50)
        print("🚀 开始在完全未见的【测试集 (Test Set)】上评估 Baseline (U-Net) 最终性能...")
